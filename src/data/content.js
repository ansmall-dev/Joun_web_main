  ...
  en: {
    ...
    about: {
      ...
      principal: {
        ...
        intro:
          'With years of experience across Australian migration and legal practice, Dow Woo Park has helped countless members of the Korean community settle and thrive in Australia, guiding each matter personally from the first consultation to the final outcome.',
      },
      values: [
        {
